...
exports.searchProduct = function(msg, callback){	
	...
	var searchQuery = "SELECT P.PRODUCT_ID,P.FARMER_ID,F.FIRST_NAME,P.PRODUCT_NAME,P.PRODUCT_PRICE,P.PRODUCT_QTY,P.PRODUCT_DESCRIPTION,P.PRODUCT_AVG_RATINGS FROM PRODUCT P,FARMER F WHERE P.APPROVED_PRODUCT='1' AND P.FARMER_ID = F.FARMER_ID AND P.PRODUCT_NAME LIKE '%"+searchString+"%' OR P.PROD_CAT LIKE '%"+searchString+"%' ORDER BY PRODUCT_ID";
