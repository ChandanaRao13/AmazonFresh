...
function getProductListCustomer(res,callback) {
	...
	var productList = '';
	var getProductList = "SELECT P.PRODUCT_ID,P.FARMER_ID,F.FIRST_NAME,F.LAST_NAME,P.PRODUCT_NAME,P.PRODUCT_PRICE,P.PRODUCT_QTY,P.PRODUCT_DESCRIPTION,P.PRODUCT_AVG_RATINGS,P.PROD_CAT FROM PRODUCT P,FARMER F WHERE P.APPROVED_PRODUCT='1' AND F.FARMER_ID = P.FARMER_ID ORDER BY P.PRODUCT_ID;";
