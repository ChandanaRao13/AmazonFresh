...
var pool =[];
var products=["Apple","Apricot","Artichoke","Asian Pear","Asparagus","Atemoya","Avocado","Bamboo Shoots","Banana","Beans","Beets","Belgian Endive","Bell Peppers","Blackberries","Blueberries","Boniato","Boysenberries","Broccoflower","Broccoli","Cabbage","Cantaloupe","Carambola","Carrots","Casaba Melon","Cauliflower","Celery","Chayote","Cherimoya","Cherries","Coconuts","Collard Greens","Corn","Cranberries","Cucumber","Dates"]
var db=config.db;
...
exports.createProducts=function(req,res){
	...
	insertData("PRODUCT", productInfo, function(err, result) {
		if (err) {
			throw err;
		} else {
