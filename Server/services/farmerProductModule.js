...
function getProductList(res,callback,farmerId) {
	var productList = '';
	var getProductList1 = "SELECT PRODUCT_ID,PRODUCT_NAME,PRODUCT_PRICE,PRODUCT_QTY,PRODUCT_DESCRIPTION,PROD_CAT,PRODUCT_AVG_RATINGS FROM PRODUCT WHERE FARMER_ID='" + farmerId + "' and APPROVED_PRODUCT='1' ORDER BY PRODUCT_ID;";
